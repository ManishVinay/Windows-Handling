...
WebElement train = driver.findElement(By.xpath("//a[@href='oracle-training.html']"));
acc.moveToElement(train).perform();
WebElement sel = driver.findElement(By.xpath("//a[@href='performance-tunning-course-content.html']"));
acc.click(sel).perform();
TakesScreenshot tk=(TakesScreenshot)driver;
File as = tk.getScreenshotAs(OutputType.FILE);
File dest=new File("F:\\Selenium Task\\Oracle.png");
